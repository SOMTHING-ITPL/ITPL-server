...
const (
	Recommender_Recommend_FullMethodName = "/recommender.Recommender/Recommend"
)
...
type RecommenderClient interface {
	Recommend(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*RecommendResponse, error)
}
...
func (c *recommenderClient) Recommend(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*RecommendResponse, error) {
...
type RecommenderServer interface {
	Recommend(context.Context, *UserRequest) (*RecommendResponse, error)
...
func (UnimplementedRecommenderServer) Recommend(context.Context, *UserRequest) (*RecommendResponse, error) {
...
func _Recommender_Recommend_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommenderServer).Recommend(ctx, req.(*UserRequest))
	}
