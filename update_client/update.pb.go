...
const file_update_proto_rawDesc = "" +
	"\n" +
	"\fupdate.proto\x12\x06update\"\x92\x01\n" +
	"\aConcert\x12\x0e\n" +
	...
	"\rUpdateRequest\x12+\n" +
	"\bconcerts\x18\x01 \x03(\v2\x0f.update.ConcertR\bconcerts\"D\n" +
	"\x0eUpdateResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage2Q\n" +
	"\x0eConcertUpdater\x12?\n" +
	"\x0eUpdateConcerts\x12\x15.update.UpdateRequest\x1a\x16.update.UpdateResponseB'Z%ITPL-server/grpc_client/update_clientb\x06proto3"
...
var file_update_proto_goTypes = []any{
	(*Concert)(nil),        // 0: update.Concert
	(*UpdateRequest)(nil),  // 1: update.UpdateRequest
	(*UpdateResponse)(nil), // 2: update.UpdateResponse
}
var file_update_proto_depIdxs = []int32{
	0, // 0: update.UpdateRequest.concerts:type_name -> update.Concert
	1, // 1: update.ConcertUpdater.UpdateConcerts:input_type -> update.UpdateRequest
	2, // 2: update.ConcertUpdater.UpdateConcerts:output_type -> update.UpdateResponse
